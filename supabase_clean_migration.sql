-- Create enums (only if not exist)
DO $$ BEGIN
...
-- Create triggers
CREATE OR REPLACE TRIGGER financial_clients_updated_at BEFORE UPDATE ON public.financial_clients
  FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();

CREATE OR REPLACE TRIGGER financial_prospects_updated_at BEFORE UPDATE ON public.financial_prospects
  FOR EACH ROW EXECUTE FUNCTION public.handle_updated_at();
